...
public class AccesspointContract {
    ...
    public static final String AUTHORITY = "com.example.android.smartwifi.accesspoint";
    ...
    public static final String PATH_ACCESSPOINT = "accesspointss";


    /* TaskEntry is an inner class that defines the contents of the task table */
    public static final class AccesspointEntry implements BaseColumns {

        // TaskEntry content URI = base content URI + path
        public static final Uri CONTENT_URI =
                BASE_CONTENT_URI.buildUpon().appendPath(PATH_ACCESSPOINT).build();

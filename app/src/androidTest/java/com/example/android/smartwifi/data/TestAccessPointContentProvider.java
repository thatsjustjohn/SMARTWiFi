...
import com.example.android.smartwifi.data.accesspointdb.AccesspointContentProvider;
import com.example.android.smartwifi.data.accesspointdb.AccesspointContract;
import com.example.android.smartwifi.data.accesspointdb.AccesspointDBHelper;
...
public class TestAccessPointContentProvider {
    ...
    @Before
    public void setUp() {
        /* Use AccesspointDBHelper to get access to a writable database */
        AccesspointDBHelper dbHelper = new AccesspointDBHelper(mContext);
        SQLiteDatabase database = dbHelper.getWritableDatabase();
        database.delete(AccesspointContract.AccesspointEntry.TABLE_NAME, null, null);
    }
    ...
    public void testProviderRegistry() {
        ...
        String taskProviderClassName = AccesspointContentProvider.class.getName();
        ...
        try {
            ...
            String expectedAuthority = packageName + ".accesspoint";
    ...
    private static final Uri TEST_TASKS = AccesspointContract.AccesspointEntry.CONTENT_URI;
    ...
    public void testUriMatcher() {
        ...
        UriMatcher testMatcher = AccesspointContentProvider.buildUriMatcher();
        ...
        int expectedTasksMatchCode = AccesspointContentProvider.ACCESSPOINT;
        ...
        int expectedTaskWithIdCode = AccesspointContentProvider.ACCESSPOINT_WITH_ID;
    ...
    public void testInsert() {
        ...
        ContentValues testAccesspointValues = new ContentValues();
        testAccesspointValues.put(AccesspointContract.AccesspointEntry.COLUMN_ACCESSPOINT, "TEST AP");
        testAccesspointValues.put(AccesspointContract.AccesspointEntry.COLUMN_MACADDRESS, "stuff");
        ...
        contentResolver.registerContentObserver(
                ...
                AccesspointContract.AccesspointEntry.CONTENT_URI,
        ...
        Uri uri = contentResolver.insert(AccesspointContract.AccesspointEntry.CONTENT_URI, testAccesspointValues);


        Uri expectedUri = ContentUris.withAppendedId(AccesspointContract.AccesspointEntry.CONTENT_URI, 1);
    ...
    public void testQuery() {
        ...
        long taskRowId = database.insert(
                ...
                AccesspointContract.AccesspointEntry.TABLE_NAME,
                null,
                /* Values to insert into table */
                testAccesspointValues);
    ...
    public void testDelete() {
        ...
        AccesspointDBHelper helper = new AccesspointDBHelper(InstrumentationRegistry.getTargetContext());
        SQLiteDatabase database = helper.getWritableDatabase();

        /* Create a new row of task data */
        ContentValues testAccesspointValues = new ContentValues();
        testAccesspointValues.put(AccesspointContract.AccesspointEntry.COLUMN_ACCESSPOINT, "TEST AP");
        testAccesspointValues.put(AccesspointContract.AccesspointEntry.COLUMN_MACADDRESS, "4");
        ...
        Uri uriToDelete = AccesspointContract.AccesspointEntry.CONTENT_URI.buildUpon().appendPath("1").build();
